...
Partial Public Class AttendanceDBDataSet
    ...
    Private relationFK__Attendanc__EmpID__5FB337D6 As Global.System.Data.DataRelation
    ...
    Friend Overloads Sub InitVars(ByVal initTable As Boolean)
        ...
        If (initTable = true) Then
            ...
            End If
        End If
        Me.relationFK__Attendanc__EmpID__5FB337D6 = Me.Relations("FK__Attendanc__EmpID__5FB337D6")
    End Sub
    ...
    Private Sub InitClass()
        ...
        Me.relationFK__Attendanc__EmpID__5FB337D6 = New Global.System.Data.DataRelation("FK__Attendanc__EmpID__5FB337D6", New Global.System.Data.DataColumn() {Me.tableEmployees.EmpIDColumn}, New Global.System.Data.DataColumn() {Me.tableAttendance.EmpIDColumn}, false)
        Me.Relations.Add(Me.relationFK__Attendanc__EmpID__5FB337D6)
    End Sub
    ...
    Partial Public Class AttendanceDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")>  _
        Public Overloads Function AddAttendanceRow(ByVal parentEmployeesRowByFK__Attendanc__EmpID__5FB337D6 As EmployeesRow, ByVal TimeIn As Date, ByVal TimeOut As Date, ByVal Status As String, ByVal FullName As String) As AttendanceRow
            Dim rowAttendanceRow As AttendanceRow = CType(Me.NewRow,AttendanceRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nothing, TimeIn, TimeOut, Status, FullName}
            If (Not (parentEmployeesRowByFK__Attendanc__EmpID__5FB337D6) Is Nothing) Then
                columnValuesArray(1) = parentEmployeesRowByFK__Attendanc__EmpID__5FB337D6(0)
            End If
    ...
    Partial Public Class EmployeesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")>  _
        Public Overloads Function AddEmployeesRow(ByVal EmpID As String, ByVal FullName As String) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            Dim columnValuesArray() As Object = New Object() {EmpID, FullName}
    ...
    Partial Public Class AttendanceRow
        ...
        Public Property EmployeesRow() As EmployeesRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("FK__Attendanc__EmpID__5FB337D6")),EmployeesRow)
            End Get
            Set
                Me.SetParentRow(value, Me.Table.ParentRelations("FK__Attendanc__EmpID__5FB337D6"))
            End Set
        End Property
    ...
    Partial Public Class EmployeesRow
        ...
        Public Function GetAttendanceRows() As AttendanceRow()
            If (Me.Table.ChildRelations("FK__Attendanc__EmpID__5FB337D6") Is Nothing) Then
                Return New AttendanceRow(-1) {}
            Else
                Return CType(MyBase.GetChildRows(Me.Table.ChildRelations("FK__Attendanc__EmpID__5FB337D6")),AttendanceRow())
            End If
        End Function
    End Class
...
Namespace AttendanceDBDataSetTableAdapters
    ...
    Partial Public Class AttendanceTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.algoflow_project.My.MySettings.Default.AttendanceDBConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    a.ID, a.EmpID, a.TimeIn, a.TimeOut, a.Status, e.FullName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM Atten"& _ 
                "dance a"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"INNER JOIN Employees e ON a.EmpID = e.EmpID"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    e.FullName,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    a.TimeIn,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    a.TimeOut,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    a.Status"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM Atten"& _ 
                "dance a"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"INNER JOIN Employees e"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ON a.EmpID = e.EmpID"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As AttendanceDBDataSet.AttendanceDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataBy() As AttendanceDBDataSet.AttendanceDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As AttendanceDBDataSet.AttendanceDataTable = New AttendanceDBDataSet.AttendanceDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmpID] = @Original_EmpID) AND ((@IsNull_Fu"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([EmpID], [FullName]) VALUES (@EmpID, @FullName);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "SELECT EmpID, FullName FROM Employees WHERE (EmpID = @EmpID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [EmpID] = @EmpID, [FullName] = @FullName WHERE (([Em"& _ 
                "pID] = @Original_EmpID) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR (["& _ 
                "FullName] = @Original_FullName)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmpID, FullName FROM Employees WHERE "& _ 
                "(EmpID = @EmpID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT EmpID, FullName FROM dbo.Employees"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As AttendanceDBDataSet.EmployeesDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As AttendanceDBDataSet.EmployeesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As AttendanceDBDataSet.EmployeesDataTable = New AttendanceDBDataSet.EmployeesDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As AttendanceDBDataSet.EmployeesDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmpID As String, ByVal Original_FullName As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal EmpID As String, ByVal FullName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal EmpID As String, ByVal FullName As String, ByVal Original_EmpID As String, ByVal Original_FullName As String) As Integer
            If (EmpID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("EmpID")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FullName As String, ByVal Original_EmpID As String, ByVal Original_FullName As String) As Integer
            Return Me.Update(Original_EmpID, FullName, Original_EmpID, Original_FullName)
        End Function
    End Class
